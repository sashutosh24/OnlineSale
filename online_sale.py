...
Original file is located at
    https://colab.research.google.com/drive/1kAZhCArKcSxnuECD_evbRQjt2i4styHr
"""
...
file_path = "Online_Sales.csv"
if os.path.exists(file_path):
    print(f"File found at: {file_path}")
    data = pd.read_csv(file_path)  # Read the CSV file
else:
    # Handle file not found - provide options to user
    print(f"Error: File not found at: {file_path}")
    print("1. Upload the 'Online_Sales.csv' file to the current directory.")
    print("2. If you have the file path, specify it below:")
    new_file_path = input("Enter the file path: ")
    try:
        data = pd.read_csv(new_file_path)  # Try reading using provided path
